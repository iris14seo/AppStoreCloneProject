...
//
//   let SoftwareDataResponse = try? newJSONDecoder().decode(SoftwareDataResponse.self, from: jsonData)

import Foundation

/**iTunes Search API 'entity=software' 조회시, 받아오는 response 구조체
 
    #파라미터
    - resultCount
    - results
 */
struct SoftwareDataResponse: Codable {
    let resultCount: Int?
...
//        let results = try container.decode([SoftWareData].self, forKey: .results)
...
/**iTunes Search API 'entity=software' 조회시, 받아오는 response의 results에서 사용되는 구조체
 */
struct SoftWareData: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case supportedDevices, advisories, isGameCenterEnabled, kind, features
        ...
        case trackName, releaseDate, sellerName, primaryGenreName
        case genreIDS = "genreIds"
        case isVppDeviceBasedLicensingEnabled, currentVersionReleaseDate, releaseNotes
